...
def _side_effects(source: dict, commitsh: str):
    ...
    :param commitsh: commit-ish (using git jargon), IoW, a commit, tag, branch name, etc
     preferably this should be a tag formatted following semantic versioning (X.Y.Z).
    """
